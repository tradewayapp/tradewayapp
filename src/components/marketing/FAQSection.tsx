...
const faqs = [
  ...
  { q: "Which forex pairs are supported?", a: "We trade 50+ major and minor pairs including EUR/USD, GBP/JPY, USD/INR, AUD/USD, and more — selected dynamically by the AI engine." },
      ...
      <div className="max-w-3xl mx-auto px-6">
        <Reveal>
          <div className="text-center mb-12">
            <p className="text-[11px] uppercase tracking-[0.28em] text-primary mb-3">FAQ</p>
        ...
        <Reveal>
          <Accordion type="single" collapsible className="panel rounded-2xl px-5">
            {faqs.map((f, i) => (
